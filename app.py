...
# USER/LOGIN (id, username, password)
...
def add_product():
    ...
    if 'name' in data and 'price' in data:
        ...
        db.session.commit()
        return jsonify({"message": "Product added succesfullly"})
...
def delete_product(product_id):
    ...
    if product != None:
        ...
        db.session.commit()
        return jsonify({"message": "Product deleted succesfullly"})
...
def remove_from_cart(product_id):
    ...
    if cart_item:
        ...
        db.session.commit()
        return jsonify({'message': "Item removed from the succesfully"})
